                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li><a href="<?= base_url('admin/department'); ?>"><i class="fa fa-dashboard fa-fw"></i> Department</a></li>
                            <li><a href="<?= base_url('admin/author'); ?>"><i class="fa fa-dashboard fa-fw"></i> Author</a></li>
                            <li><a href="<?= base_url('admin/publication'); ?>"><i class="fa fa-dashboard fa-fw"></i> Publication</a></li>
